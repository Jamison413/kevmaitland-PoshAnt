...
$csvFiles = @("C:\Users\kevin.maitland\OneDrive - Anthesis LLC\Desktop\2020_eco3_deemed_scores_v1.4_0_1.csv","C:\Users\kevin.maitland\OneDrive - Anthesis LLC\Desktop\2020_eco3_deemed_scores_v1.4_0_2.csv","C:\Users\kevin.maitland\OneDrive - Anthesis LLC\Desktop\2020_eco3_deemed_scores_v1.4_0_3.csv","C:\Users\kevin.maitland\OneDrive - Anthesis LLC\Desktop\2020_eco3_deemed_scores_v1.4_0_4.csv","C:\Users\kevin.maitland\OneDrive - Anthesis LLC\Desktop\2020_eco3_deemed_scores_v1.4_0_5.csv")
...
$csvFiles | % {
    ...
    $csvData = import-csv $csvFiles[$j]
    $myThings = @(0) * ($csvData.Count)

    #$csvData | %{
    foreach ($thisRow in $csvData){
        ...
        $thisObject.lifetime = $thisRow.Lifetime
        ...
        $thisObject.bedrooms = $thisRow.Property_Type.Split("_")[2]
        $thisObject.issPropertyType = "Flat"
        $thisObject.issExtWalls = "2 or fewer"
        if([string]$thisObject.bedrooms -eq "3+"){$thisObject.issBedrooms = "3 or more"}
        else{$thisObject.issBedrooms = [string]$thisObject.bedrooms}
        }
                                    elseif($thisRow.Property_Type -match "3W_Flat"){
        $thisObject.propertyType = "3 ext. Wall Flat"
        $thisObject.bedrooms = $thisRow.Property_Type.ToString().Split("_")[2]
        $thisObject.issPropertyType = "Flat"
        $thisObject.issExtWalls = "3 or more"
        if($thisObject.bedrooms -eq "3+"){$thisObject.issBedrooms = "3 or more"}
        else{$thisObject.issBedrooms = [string]$thisObject.bedrooms}
        }
                                    elseif($thisRow.Property_Type -match "End-terrace"){
        $thisObject.propertyType = "End-terrace"
        $thisObject.bedrooms = $thisRow.Property_Type.Split("_")[1]
        $thisObject.issPropertyType = "House"
        $thisObject.issDetatchment = "End-Terrace"
        if([string]$thisObject.bedrooms -eq "5+"){$thisObject.issBedrooms = "5 or more"}
        else{$thisObject.issBedrooms = [string]$thisObject.bedrooms.ToString()}
        }
        ...
        if([string]$thisObject.bedrooms -eq "2-"){$thisObject.issBedrooms = "2 or fewer"}
        elseif([string]$thisObject.bedrooms -eq "5+"){$thisObject.issBedrooms = "5 or more"}
        else{$thisObject.issBedrooms = [string]$thisObject.bedrooms}
        }
        ...
        if([string]$thisObject.bedrooms -eq "2-"){$thisObject.issBedrooms = "2 or fewer"}
        elseif([string]$thisObject.bedrooms -eq "6+"){$thisObject.issBedrooms = "6 or more"}
        else{$thisObject.issBedrooms = [string]$thisObject.bedrooms}
        }
        ...
        $thisObject.issDetatchment = "End-Terrace"
        if([string]$thisObject.bedrooms -eq "2-"){$thisObject.issBedrooms = "2 or fewer"}
        elseif([string]$thisObject.bedrooms -eq "3+"){$thisObject.issBedrooms = "3 or more"}
        else{$thisObject.issBedrooms = [string]$thisObject.bedrooms}
        }
        ...
        $thisObject.issExtWalls = "2 or fewer"
        if([string]$thisObject.bedrooms -eq "3+"){$thisObject.issBedrooms = "3 or more"}
        else{$thisObject.issBedrooms = "2 or fewer"}
        }
    ...
    $myThings | Export-Csv -Path "c:\users\kevin.maitland\OneDrive - Anthesis LLC\desktop\deemed$j.csv" -NoTypeInformation
    $j++
