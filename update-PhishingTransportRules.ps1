...
$ukRule | Set-TransportRule -Name $ukRuleName -Priority 0 -FromScope "NotInOrganization" -ApplyHtmlDisclaimerLocation "Prepend" -HeaderMatchesMessageHeader From -HeaderMatchesPatterns $ukDisplayNames -ApplyHtmlDisclaimerText $ruleHtml -SentTo $null
$nonUkRule | Set-TransportRule -Name $nonUkRuleName -Priority 0 -FromScope "NotInOrganization" -ApplyHtmlDisclaimerLocation "Prepend" -HeaderMatchesMessageHeader From -HeaderMatchesPatterns $nonUkDisplayNames -ApplyHtmlDisclaimerText $ruleHtml -SentTo $null #kevin.maitland@anthesisgroup.com
