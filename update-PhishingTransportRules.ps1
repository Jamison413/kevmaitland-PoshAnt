...
$restOfWorldRuleName = "External Senders with matching RoW-UK Display Names"
...
$roWRule | Set-TransportRule -Name $roWDisplayNames -Priority 0 -FromScope "NotInOrganization" -ApplyHtmlDisclaimerLocation "Prepend" -HeaderMatchesMessageHeader From -HeaderMatchesPatterns $nonUkDisplayNames -ApplyHtmlDisclaimerText $ruleHtml -SentTo $null  -ExceptIfFrom "noreply@email.teams.microsoft.com" #kevin.maitland@anthesisgroup.com
