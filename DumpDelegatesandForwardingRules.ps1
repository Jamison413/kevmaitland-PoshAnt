...
$UserInboxRules | Export-Csv $env:USERPROFILE\Desktop\AuditLogs\MailForwardingRulesToExternalDomains.csv
$UserDelegates | Export-Csv $env:USERPROFILE\Desktop\AuditLogs\MailboxDelegatePermissions.csv
$SMTPForwarding | Export-Csv $env:USERPROFILE\Desktop\AuditLogs\Mailboxsmtpforwarding.csv