...
<#EP note: Can we omit this one as it seems to be blank or not working, not sure what we are using as a source Sharepoint profile#>
...
<#EP note: Can we omit this one? Trying to move from XDrive onto OneDrive or Sharepoint for this purpose?#>
