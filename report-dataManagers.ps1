...
$newauthorisedDataManagers | % {
    $thisUser = $_
    write-host "Welcoming $($thisUser.FieldValues.User.Email)" -ForegroundColor Yellow
    ...
    $welcomeBodyTrunk += "Just as a quick reminder, <A HREF='https://anthesisllc.sharepoint.com/sites/Resources-IT/_layouts/15/DocIdRedir.aspx?ID=HXX7CE52TSD2-248671567-12333'>the slides from the training session</A> are available for you to revist, and we have <A HREF='https://anthesisllc.sharepoint.com/sites/Resources-IT/SitePages/SharePoint-Training-Guides.aspx#data-managers-guides'>a series of Data Manager self-help guides</A> available too.<BR><BR>`r`n`r`n"
    $welcomeBodyTrunk += "You can now request new <A HREF='https://anthesisllc.sharepoint.com/clients/Lists/External%20Site%20Requests/My%20Requests.aspx'>project</A>, <A HREF='https://anthesisllc.sharepoint.com/subs/Lists/External%20Subcontractor%20Site%20Requests/My%20Requests.aspx?viewpath=%2Fsubs%2FLists%2FExternal%20Subcontractor%20Site%20Requests%2F'>supplier</A> or <A HREF='https://anthesisllc.sharepoint.com/sites/TeamHub/Lists/Internal%20Team%20Site%20Requests/AllItems.aspx?viewid=a05bf03a-9bbf-4def-bc98-51d1ba20dbd7'>internal</A> teams with you as a Data Manager. If you want to be added/reinstated as a Data Manager for an existing team you can email the <A HREF='mailto:itteamall@anthesisgroup.com'>IT Team</A> with the name(s) of the teams and/or links.<BR><BR>`r`n`r`n"
...
Send-MailMessage -From groupbot@anthesisgroup.com -SmtpServer "anthesisgroup-com.mail.protection.outlook.com" -Subject "Data Manager Summary $(Get-Date -f "yyyy-MM-dd")" -BodyAsHtml $overviewBodyTrunk -To $groupAndExchangeAdmins -Encoding UTF8
#endregion
